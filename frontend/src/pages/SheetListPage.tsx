    ...
    <div className="max-w-4xl mx-auto space-y-4 sm:space-y-5 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link to="/quick" className="flex items-center gap-1 px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium t-accent-light transition-all hover:opacity-80">⚡ 快速决策</Link>
